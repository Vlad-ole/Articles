...
Set $\alpha_{1}$ соответствует двум близкорасположенным сигналам, причем их суммарная амплитуда вдвое больше амплитуды одноэлектронного импульса.
...
Аналогичную корреляцию можно построить и для множества $B_{2}$ (Fig.~\ref{image:Hamamatsu_S10362-11-100C_295K_1_OV_amp1_amp2_dt_B2}).
...
В результате получим спектр временных интервалов, изображенный на Fig.~\ref{image:Hamamatsu_S10362-11-100C_295K_1_OV_dt_spectrum}.
...
На Fig.~\ref{image:Hamamatsu_S10362-11-100C 295K_1_OV_dt_spectrum_timecut} приведена зависимость параметра $\tau_{f}$ от "временного" порога.
...
В результате аппроксимации спектра временных интервалов получены зависимости частоты темнового шума от температуры и перенапряжения (Fig.\ref{image:Hamamatsu_S10362-11-100C_dc_vs_T}, \ref{image:Hamamatsu_S10362-11-100C_dc_vs_V}, \ref{image:Hamamatsu_S13360-3050CS_dc_vs_V_rus}, \ref{image:Hamamatsu_S13360-3050CS_dc_vs_V_rus}).
...
В множестве $A_{1}$ (Fig.~\ref{image:Hamamatsu_S10362-11-100C_295K_1V_Chi2_amp 1}) содержатся одноэлектронные импульсы.
...
В множестве $A_{2}$ (Fig.~\ref{image:Hamamatsu_S10362-11-100C_295K_1_OV_Chi2_amp1_amp2}) содержатся импульсы, вызванные срабатыванием либо одной ячейки с последующим послеимпульсом, либо двух ячеек в разные моменты времени из-за темновых токов.
...
Результаты обработки приведены на Fig. \ref{image:Hamamatsu_S10362-11-100C_xtalk_vs_T}, \ref{image:Hamamatsu_S10362-11-100C_xtalk_vs_V}, \ref{image:Hamamatsu_S13360-3050CS_xtalk_vs_V_rus}, \ref{image:KETEK_PM1125NS_SB0_x-tlak_vs_V_rus}.
