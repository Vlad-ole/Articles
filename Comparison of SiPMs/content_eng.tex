...
In this article we study dark noise, probabilities of cross-talk and after-pulsing at different voltages and temperatures for two modern SiPM: Hamamatsu S13360-3050CS and KETEK PM1125NS-SB0 and Hamamatsu S10362-11-100C SiPM from the previous generation.
...
As a result, we found that in achieved measurement accuracy dark noise has a temperature and a voltage dependence, but cross-talk and after-pulsing probabilities have only the latter.

Measured cross-talk probabilities for KETEK PM1125NS-SB0 and Hamamatsu S13360-3050CS at their operating voltage is about 6\%
...
SiPM is mounted on a thermoelectric cooler and the temperature stabilization is ensured by the TRM 101 PID controller.
...
Then the tops of the noise peak and the peak from the registration of single photons were approximated by a Gaussian function.
