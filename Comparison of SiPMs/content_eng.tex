...
Hamamatsu S10362-11-100C at 1V overvoltage and 295K temperature. Only signals exceeding the threshold $th_{amp}^{stop} = 2 mV /s$ were selected.}
...
The $A_{2}$ cluster consists of signals that are conventionally divided into two sets: $\alpha_{1}$ è  $\beta_{1}$.
